...
from algorithms.actor_critic.share_a2c import ActorCriticAgent
from commons.utils import plot_figure

if __name__ == '__main__':
    with open(os.path.join(os.path.dirname(__file__), "configs", "actor_critic", "share_a2c.yaml"), "r") as f:
        try:
