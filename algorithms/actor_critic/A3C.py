...
class ActorCriticAgent:
    ...
    def train(self):
        ...
        #     self.args.regularization_coeffient *= self.args.entropy_coeffient_decay
        ...
        for i in range(self.args.K_epoch):
            ...
            for batch in batches:
                ...
                # L2 regularization
                if self.args.use_regularization:  # false
                    for name, param in self.critic.named_parameters():
                        if 'weight' in name:
                            critic_loss += self.args.regularization_coeffient * param.pow(2).sum()
